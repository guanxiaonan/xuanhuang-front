<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit
      ...
      <el-table-column width="110px" align="center" label="施肥区域">
        <template slot-scope="scope">
          <span>{{scope.row.price}}</span>
        </template>
      </el-table-column>
      <el-table-column width="110px" align="center" label="施肥量（品种/量）">
        <template slot-scope="scope">
          <span>{{scope.row.shopName}}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="施肥人员" width="95">
        <template slot-scope="scope">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-tabs v-model="activeName">
          <el-tab-pane label="基本" name="first">
            <el-form-item label="施肥时间" prop="name">
            ...
            <!-- </el-form-item> -->
            <el-form-item label="施肥区域" prop="shopName">
              <el-input v-model="form.shopName"></el-input>
            </el-form-item>
            <el-form-item label="施肥量（品种/量）" prop="postFare">
              <el-input v-model="form.postFare"></el-input>
            </el-form-item>
            <el-form-item label="施肥人员" prop="designCost">
  ...
  export default {
    ...
    methods: {
      ...
      change(row) {
        ...
        this.$confirm('你确定将此方案上架吗, 是否继续?', '提示', {
          confirmButtonText: '确定',
          cancelButtonText: '取消',
          type: 'warning'
        }).then(() => {
          this.request.action = 2
